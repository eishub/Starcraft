\chapter{Environment}
This chapter will explain how to set up and start a bot with the StarCraft environment using a multi-agent system in the GOAL language.= For the latest installation instructions, we refer to: \\ \url{https://github.com/eishub/StarCraft/wiki/Install-Guide}
